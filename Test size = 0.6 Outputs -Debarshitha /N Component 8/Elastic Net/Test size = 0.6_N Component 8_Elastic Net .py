...
# Load files (Ensure the combined files contain at least 9 unique target classes)
...
y_pred = np.clip(np.round(y_pred), 0, len(labelencoder_y.classes_) - 1).astype(int)
